...
switch current_sub_panel
    ...
    case 'itpc'
        ...
        adv_out_mod_button_list = [{{'style','checkbox','string', 'Include Max ITPC in Excel Report?','tag','itpc_xls_max_on','Value',grp_proc_info.beapp_itpc_xlsout_mx_on}},...
            ...
            {{'style','checkbox','string', 'Use common baseline (across stimuli)?','tag','itpc_comm_base_on','Value',grp_proc_info.beapp_itpc_ersp_params.use_common_baseline}}...
            {{'style','text','string', 'Common baseline index'}},...
            {{'style','edit','string',grp_proc_info.beapp_itpc_ersp_params.common_baseline_idx,'tag','itpc_comm_base_idx'}}];
...
%HS add advanced pac settings 11/03/2023
    case 'pac'
        ...
        adv_out_mod_button_geometry ={1 1 1 1};
        adv_out_mod_ver_geometry =[1 1 1 1];  
