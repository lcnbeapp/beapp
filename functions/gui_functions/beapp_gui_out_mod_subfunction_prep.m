...
switch current_sub_panel
    ...
    case 'itpc'
        %{{'style','edit','string', num2str(grp_proc_info.beapp_itpc_ersp_params.win_size),'tag','itpc_win_size'}},...
        out_mod_button_list = [{{'style','text','string', 'ITPC Module Settings:'}},...
            {{'style','checkbox','string', 'Set frequency range? (Frequency inputs below will not be used if unchecked)','tag','itpc_set_freq_range','Value',grp_proc_info.beapp_itpc_ersp_params.set_freq_range}}...
            {{'style','text','string', 'frequency range (min,max):'}},...
            {{'style','edit','string',  grp_proc_info.beapp_itpc_ersp_params.min_freq,'tag', 'itpc_min_freq'}}...
            {{'style','edit','string',  grp_proc_info.beapp_itpc_ersp_params.max_freq,'tag', 'itpc_max_freq'}}...
            {{'style','text','string', 'Number of cycles in each Morlet Wavelet at (min,max) frequencies:'}},...
            {{'style','edit','string',  grp_proc_info.beapp_itpc_ersp_params.min_cyc,'tag', 'itpc_min_cyc'}}...
            {{'style','edit','string',  grp_proc_info.beapp_itpc_ersp_params.max_cyc,'tag', 'itpc_max_cyc'}}...
            {{'style','checkbox','string', 'Normalize ERSP to baseline?','tag','itpc_base_norm_on','Value',grp_proc_info.beapp_itpc_ersp_params.baseline_norm}}...
