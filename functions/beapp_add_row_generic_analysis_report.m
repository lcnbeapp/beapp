...
function [report_info,all_condition_labels,all_obsv_sizes] = beapp_add_row_generic_analysis_report(report_info,all_condition_labels,all_obsv_sizes,curr_file,file_proc_info,eeg_w,diagnosis_map)
...
report_info.Diagnosis(curr_file)= convertCharsToStrings(diagnosis_map{([diagnosis_map{:,1}]==file_proc_info.diagnosis),2}); %TH
