...
% function takes run template from previous run

function gen_HAPPE_output_table_after_crash()
...
writetable(ICA_report_table, ['ICA_Report_Table ',grp_proc_info.beapp_curr_run_tag,'_after_crash.csv']);
clear grp_proc_info.